...
Course.create(name: "Advanced Excel 2016 Course", description: "Advanced Excel 2016", user_id: User.find_by(name: "Pyay").id)
Course.create(name: "MYOB Course", description: "MYOB", user_id: User.find_by(name: "Pyay").id)
Course.create(name: "AutoCAD Course", description: "AutoCAD (General)", user_id: User.find_by(name: "Pyay").id)
Course.create(name: " Professional Excel Course", description: "Professional Excel", user_id: User.find_by(name: "Pyay").id)
...
Course.create(name: "D.T.P Course", description: "Adobe PageMaker 7.0 \n Advanced Excel 2016", user_id: User.find_by(name: "Magway").id)
Course.create(name: "Advanced Excel 2016 Course", description: "Advanced Excel 2016", user_id: User.find_by(name: "Magway").id)

#dawei
Course.create(name: "Office 2016 Course", description: "Window's 10 \n Microsoft Word 2016 \n Microsoft Excel 2016  \n Microsoft Power Point 2016  \n Scanning and Printing", user_id: User.find_by(name: "Dawei").id)
Course.create(name: "D.T.P Course", description: "Corel Draw X4   \n Adobe Photoshop C.S.3   \n Adobe PageMaker 7.0   \n Adobe Acrobat 7.0 \n Scanning and Printing", user_id: User.find_by(name: "Dawei").id)
Course.create(name: "Advanced Excel 2016 Course", description: "Advanced Excel 2016", user_id: User.find_by(name: "Dawei").id)
